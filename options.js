...
async function saveOptions() {
    ...
    const ytHandling = document.getElementById("ytHandling").checked;
    ...
    await chrome.storage.local.set({ openInBackground, showToast, ytHandling, whitelist });
...
async function restoreOptions() {
    const {
        ...
        ytHandling = true,
        whitelist = [],
    } = await chrome.storage.local.get(["openInBackground", "showToast", "ytHandling", "whitelist"]);

    document.getElementById("openInBackground").checked = openInBackground;
    document.getElementById("showToast").checked = showToast;
    document.getElementById("ytHandling").checked = ytHandling;
